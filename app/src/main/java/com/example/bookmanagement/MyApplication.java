...
public class MyApplication extends Application {
                        ...
                        reference.child(bookId)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        Toast.makeText(context, "Books Deleted Success", Toast.LENGTH_SHORT).show();
        ...
        storageReference.getBytes(MAX_BYTES_PDF)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(context, "Tai that bai"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private static void saveBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        ...
        try {
            ...
            Toast.makeText(context, "Tai ve folder", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(context, "Tai ve that bai", Toast.LENGTH_SHORT).show();
            progressDialog.dismiss();
        }
    }
